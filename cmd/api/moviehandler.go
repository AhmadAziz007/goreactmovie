...
func (app *application) getOneMovie(rw http.ResponseWriter, r *http.Request) {
	...
	movie, err := app.models.DB.FindMovieById(id)
...
func (app *application) getAllMovie(rw http.ResponseWriter, r *http.Request) {
	...
	movies, err := app.models.DB.FindAllMovie()
	if err != nil {
		app.errorJSON(rw, err)
		return
	}
...
func (app *application) getAllGenres(rw http.ResponseWriter, r *http.Request) {
	...
	genres, err := app.models.DB.FindAllGenre()
	if err != nil {
		app.errorJSON(rw, err)
		return
	}
...
func (app *application) getAllMoviesByGenres(rw http.ResponseWriter, r *http.Request) {
	...
	movies, err := app.models.DB.FindAllMovie(genreID)
	if err != nil {
		app.errorJSON(rw, err)
		return
	}
...
func (app *application) editMovie(rw http.ResponseWriter, r *http.Request) {
	...
	singleMovie, _ := app.models.DB.FindMovieById(id)
	movie = *singleMovie
